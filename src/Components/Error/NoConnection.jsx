...
const NoConnection = () => {
    return (
        <div className={style.ErrorConnect}>
            ...
            <p className={style.ErrorConnect_desc}>Произошла ошибка.<br/>Пожалуйста проверьте свое интернет подключение,<br/>правильность введенных данных или попробуйте позже</p>
        </div>
    )
}
